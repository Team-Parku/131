...
class addData2 extends JPanel{
   ...
   public addData2(JPanel contentPane){
	...
	private void init() {
		...
		//selectParks.setModel(new DefaultComboBoxModel(new String[] parkList);
		top.add(selectParks);
      ...
      AL1 = new ActionListener(){      
         public void actionPerformed(ActionEvent ae){
            ...
            if(ae.getSource() == submit){
               ...
               numVehicle = getNumVehicle();
               numNonVehicle = getNumNonVehicle();
               siteCFT = getSiteCFT();
               ...
               if(A.isEmpty()){
                  ...
                  //addes nonVehicle and Vehicle together to total
   ...
   public String getNumVehicle(){
      String A = vehicle.getText();
      return A;
  }
  
   public String getNumNonVehicle(){
      String A = nonVehicle.getText();
      return A;
   }
   ...
   public String getTotAttendence(){
      int numVeh, numNonVeh;
      String veh = vehicle.getText();
      String nonveh = nonVehicle.getText();
      if(veh.isEmpty()){
         numVeh = 0;
      }else {
         numVeh = Integer.parseInt(vehicle.getText());
      }
      if(nonveh.isEmpty()){
         numNonVeh = 0;
      }else{
         numNonVeh = Integer.parseInt(nonVehicle.getText());
      }
      
      int A = numVeh + numNonVeh; 
